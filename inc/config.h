...
#define BAT_LOW_LVL2            3.1       // your battery is almost empty. Charge now! [V/cell]
#define BAT_LOW_DEAD            2.9      // undervoltage poweroff. (while not driving) [V/cell]
...
// ################ UART CONFIG ##########
  ...
  #define MANUEL_CONTROL                             // disable if using steering!
...
#define BEEPS_BACKWARD 0    // 0 or 1 -- god damn it is annoying asf
